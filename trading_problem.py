...
class TradingProblem(ElementwiseProblem):
    ...
    *** Still need to add 1 to n_vars for stop-loss gene ***
    ...
    def __init__(self, data: Tensor, network: DataParallel[PolicyNetwork] | PolicyNetwork, environment: TradingEnvironment, *args, **kwargs):
        ...
        self.chromsome: int = 0 # Int representing he individual's chromsome for mapping/visualization/selection purposes

    def get_chromsome(self):
        """Updates the chromsome and returns it."""
        self.chromsome %= 100
        self.chromsome += 1
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        profit, drawdown = self.environment.simulate_trading(self.get_chromsome())  # Simulate trading
